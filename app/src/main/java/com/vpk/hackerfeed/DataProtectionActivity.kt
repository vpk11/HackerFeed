...
fun DataProtectionScreen() {
    ...
    Scaffold(
        topBar = {
            ThemedTopAppBar(
                title = {
                    Text(text = stringResource(id = R.string.data_protection_title))
                },
                navigationIcon = {
                    IconButton(onClick = {
        ...
        val htmlContent = stringResource(id = R.string.data_protection_content)
...
@Composable
fun DataProtectionScreenPreview() {
    HackerFeedTheme {
        DataProtectionScreen()
    }
}
